function Plane = fus_align(Plane,display)
% Plane = fus_align(Plane,display)
%
% Rigid alignment of planes
%
% Updates Plane.I.transform with affine transformation matrix, but does not
% apply the transform
